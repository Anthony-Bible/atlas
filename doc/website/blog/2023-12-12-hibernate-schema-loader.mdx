...
Please reach out to us on [Discord](https://discord.gg/zZ6sWVg6NT) or by opening an [issue](https://github.com/anthony-bible/atlas-provider-hibernate/issues/new).
:::
...
For this demo, we are going to use Gradle, PostgreSQL and this [example project](https://github.com/anthony-bible/atlas-provider-hibernate/tree/master/examples/e2e_java_example).
...
If you want to explore more configuration options or dive deeper into how this works, please take a look at this [repository](https://github.com/anthony-bible/atlas-provider-hibernate).
