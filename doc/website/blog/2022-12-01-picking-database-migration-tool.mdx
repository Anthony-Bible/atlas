...
**[Atlas](https://github.com/anthony-bible/atlas)** - *Created: 2021 GitHub Stars: 2.1k*<br />
...
- 1: Atlas provides [a few packages](https://pkg.go.dev/github.com/anthony-bible/atlas#section-directories) related to database operations, but the use is limited to complex cases
