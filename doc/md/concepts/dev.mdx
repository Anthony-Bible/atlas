...
The code for the above examples is available in the [ariga/atlas-examples](https://github.com/anthony-bible/atlas-examples) repository,
within the [migrate-diff-hcl](https://github.com/anthony-bible/atlas-examples/tree/master/atlashcl/migrate-diff-hcl) and
[schema-apply-sql](https://github.com/anthony-bible/atlas-examples/tree/master/atlashcl/schema-apply-sql) directories.
