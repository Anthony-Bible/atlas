...
Support for other secret stores is planned, if you have a specific request, please [open an issue](https://github.com/anthony-bible/atlas/issues/new).
...
if you have a specific request, please [open an issue](https://github.com/anthony-bible/atlas/issues/new).
