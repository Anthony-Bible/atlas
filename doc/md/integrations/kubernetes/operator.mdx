...
You can find the full definition for this resource on the [ariga/atlas-operator repo](https://github.com/anthony-bible/atlas-operator/blob/master/charts/atlas-operator/templates/crds/crd.yaml).
