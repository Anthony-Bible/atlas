...
we provide a simple wrapper SDK called [`atlasexec`](https://github.com/anthony-bible/atlas-go-sdk/tree/master/atlasexec) 
...
```bash
go get github.com/anthony-bible/atlas-go-sdk/atlasexec
```
...
import (
	...
	"github.com/anthony-bible/atlas-go-sdk/atlasexec"
)
...
For more information, please refer to the [package documentation](https://pkg.go.dev/github.com/anthony-bible/atlas-go-sdk@master/atlasexec).
