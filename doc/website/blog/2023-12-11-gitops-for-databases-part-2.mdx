...
This is the second post in a two-part tutorial, which demonstrates how to use the [Atlas Operator](https://github.com/anthony-bible/atlas-operator) in tandem with
...
and is designed to run natively in Kubernetes. The [Atlas Operator](https://github.com/anthony-bible/atlas) enables teams
