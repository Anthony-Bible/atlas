...
it supported, [let us know!](https://github.com/anthony-bible/atlas/issues/new)
...
A fully working implementation can be found in the [`atlas-provider-gorm`](https://github.com/anthony-bible/atlas-provider-gorm)
